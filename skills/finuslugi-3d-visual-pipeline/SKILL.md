...
Use this skill to transform an idea or reference into a new, style-consistent Finuslugi 3D image. The skill owns analysis, specification, prompt planning, iteration control, QA, and delivery. The installed image generation tool owns the actual generation or edit execution.

Do not treat the reference as a complete brief. Do not jump directly from an image to one long prompt.
...
7. **Select one style pack and version.**
